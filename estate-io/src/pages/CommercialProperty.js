  ...
  function Property() {
      ...
      useEffect(() => {
          ...
          const fetchProperties = async () => {
            try {
              const rentResponse = api.get("/api/commercial-properties-rent/");
              const saleResponse = api.get("/api/commercial-properties-sale/");
        ...
        if (property) {
          ...
          try {
            ...
            const adjustedAppointments = response.data.map(appointment => {
              ...
              return {...appointment, time: date.toISOString()};
            });
      ...
      // Fetch appointments when the component mounts or when property or propertyId changes
      useEffect(() => {
        fetchAppointments();
      }, [property, propertyId]);

      // Fetch appointments when the "Schedule Visit" button is clicked
                ...
                <Card className="card-shadow-custom">
                  ...
                  <CardBody>
                    <div className="d-flex justify-content-between">
                      ...
                      <Button color="dark" onClick={handleScheduleVisitClick}>
                        Schedule Visit
                      </Button>
                    </div>
